...
public class Game implements Iterable {
	...
	private static int NPLAYERS = 10; 	//NPlayers specified, in this instance 10 players (can change to desired number)
	private static int NTURNS = 100;	//NTurns specified, so each player will have a 100 turns (can change to desired number)


	/* Method to get the NTURNS Which will help the players determine 
